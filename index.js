...
//
 function startLandmarkDetection(video) {
...
let buttonR = document.getElementById('rock')
let buttonP = document.getElementById('paper')
let buttonS = document.getElementById('scissors')
const classify = document.querySelector("#classify");


function buttonRHandler() {
    machine.learn(webcamdata,'rock')
    log.innerHTML = "learning rock"
}

function buttonPHandler() {
    machine.learn(webcamdata, 'paper')
    log.innerHTML = "learning paper"
}

function buttonSHandler() {
    machine.learn(webcamdata, 'scissors')
    log.innerHTML = "learning scissors"
}
...
buttonR.addEventListener("click", () => buttonRHandler());
buttonP.addEventListener("click", () => buttonPHandler());
